...
const config = {
	...
	kit: {
		...
		paths: {
			// ~~~ IMPORTANT UPDATE 2023-04
			// DEV_NOTE # === 'npx vite build' === PLUS YOU MUST manually remove '{github_repo_name + github_suffix}' computed prefix for './_app/etc.' ; refer ./docs/ lines 8-9 !
			base: Boolean(parsed || process.env.NODE_ENV_PROD) ? '' /* (github_repo_name + github_suffix) */ : (github_repo_name),
		},
	},
}
